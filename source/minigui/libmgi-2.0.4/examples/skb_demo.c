...
{ 
    ...
    */
    ...
    {
        CTRL_BUTTON,
        WS_VISIBLE | BS_AUTOCHECKBOX | BS_LEFTTEXT | BS_RIGHT | WS_CHILD, 
        20, 380, 80, 34,
        IDC_GB2312,
        "GB2312",
        0
